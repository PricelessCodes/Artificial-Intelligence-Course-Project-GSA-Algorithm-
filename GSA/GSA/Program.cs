...
namespace GSA
{
    class Program
    {
        ...
        static public void GSA_Algorithm()
        {
            int Flag = 0;
                ...
                for (i = 0; i < Nodes.Count; i++)
                {
                    if (Nodes[i].Name == Opened[0].Name)
                    {
                        ...
                        if (Opened[0].Name == "G1" || Opened[0].Name == "G2")
                        {
                            ...
                            List<Node> SortedList = Opened.OrderBy(o => o.H).ToList();
                            Opened = SortedList;
            ...
            for (i = 0; i < All.Count; i++)
            {
                ...
                for (j = 0; j < All[i].Opened.Count; j++)
                {
                    if (j == All[i].Opened.Count - 1)
                        Console.Write(All[i].Opened[j].Name + "(" + All[i].Opened[j].H + ")" + "]");
                    else
                        Console.Write(All[i].Opened[j].Name + "(" + All[i].Opened[j].H + ")" + ",");
                }
                ...
                else
                {
                    ...
                    for (j = 0; j < All[i].Closed.Count; j++)
                    {
                        if (j == All[i].Closed.Count - 1)
                            Console.WriteLine(All[i].Closed[j].Name + "(" + All[i].Closed[j].H + ")" + "]");
                        else
                            Console.Write(All[i].Closed[j].Name + "(" + All[i].Closed[j].H + ")" + ",");
                    }
                }
            }
        }
